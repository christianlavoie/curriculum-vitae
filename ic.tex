...
\begin{langen}
\cventry{2010--present}{Owner and sole employee}{\Large Sand Reckoning Consulting}{Montr\'{e}al, Canada}{}{\tiny Sand Reckoning is a single-owner, single-employee corporation enabling international freelancing and consulting opportunities.}
\begin{description}%
...
\begin{langen}
\cventry{2004--2010}{Senior Software Engineer}{\Large Google}{Mountain View, California}{}{Tech Lead twice (almost youngest at Google once); programmer and sysadmin for systems at the biggest scale in the world. Recognized as able to contribute to \emph{any} project: first to reach seven ``readabilities'': Borgmon, C++, Java, JavaScript, Perl, Python and Sawzall.}
\begin{description}%
\vspace{2 mm}
