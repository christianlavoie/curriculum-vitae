...
\familyname{Lavoie}
\title{CV}
\address{151 Atwater, CP 72107}{H3J 2Z6, Montr\'eal, Canada}
...
\begin{description}
\item[Applications] Apache HTTPD, Hadoop, HAProxy, Nagios, NGiNX, NodeJS
...
\item[Syst\`{e}mes d'exploitation] Debian, FreeBSD, RHEL, Ubuntu
\end{description}
...
\item 2005--2007: \textit{Froogle} et \textit{Google Base} Chef d'\'{e}quipe pour un groupe de 5 d\'{e}veloppeurs et programmeurs juniors. En charge du design, de la programmation et de toutes les activit\'{e}s de d\'{e}veloppement d'un sys\`{e}mes \`{a} tr\'{e} grande \'{e}chelle.
...
\begin{itemize}%
\item Premi\`{e}re exp\'{e}rience en charge d'une \'{e}quipe -- une programmeure juniore sous ma supervision.
\end{itemize}}

\vspace{4 mm}

\cventry{2003}{Auxiliaire d'enseignement}{Universit\'{e} McGill}{Montr\'{e}al, Canada}{}{Assistant Doina Pr\'{e}cup, pour le cour COMP-424: Intelligence Artificielle.
\begin{itemize}%
\item Un des rares assistants de professeur \`{a} McGill encore au niveau du Bac.
...
\item[Montr\'{e}al Tech Leads] Organisateur du regroupement de programmeurs s\'{e}niors et chefs techniques d'entreprisese de la grande r\'{e}gion de Montr\'{e}al.
\item[Thrift--Haskell] Responsable du d\'{e}veloppement de la librairie Thrift en Haskell, maintenue par le groupe Apache Thrift.
\end{description}
